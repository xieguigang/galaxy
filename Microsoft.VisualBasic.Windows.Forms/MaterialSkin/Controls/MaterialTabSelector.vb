...
Namespace Controls
    ...
    Public Class MaterialTabSelector
        ...
        Protected Overrides Sub OnPaint(e As PaintEventArgs)
            ...
            'Draw tab headers
            For Each tabPage As System.Windows.Forms.TabPage In m_baseTabControl.TabPages
                ...
                g.DrawString(tabPage.Text.ToUpper(), SkinManager.ROBOTO_MEDIUM_10, textBrush, tabRects(currentTabIndex), New StringFormat() With {
