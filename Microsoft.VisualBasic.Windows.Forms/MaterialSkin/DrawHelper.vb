...
Public Module DrawHelper
    ...
    Public Function CreateRoundRect(x As Single, y As Single, width As Single, height As Single, radius As Single) As GraphicsPath
    ...
    Public Function CreateRoundRect(rect As Rectangle, radius As Single) As GraphicsPath
        Return CreateRoundRect(rect.X, rect.Y, rect.Width, rect.Height, radius)
    End Function

    Public Function BlendColor(backgroundColor As Color, frontColor As Color, blend As Double) As Color
    ...
    Public Function BlendColor(backgroundColor As Color, frontColor As Color) As Color
