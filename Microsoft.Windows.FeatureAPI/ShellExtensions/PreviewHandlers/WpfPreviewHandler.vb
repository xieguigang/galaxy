    ...
    Public MustInherit Class WpfPreviewHandler
		...
		Protected Sub UpdatePlacement()
			If _source IsNot Nothing Then
				...
				HandlerNativeMethods.SetWindowPos(_source.Handle, New IntPtr(CInt(SetWindowPositionInsertAfter.Top)), 0, 0, Math.Abs(_bounds.Left - _bounds.Right), Math.Abs(_bounds.Top - _bounds.Bottom), _
