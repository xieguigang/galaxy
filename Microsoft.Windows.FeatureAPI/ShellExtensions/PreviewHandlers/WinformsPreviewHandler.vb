...
Namespace ShellExtensions
    ...
    Public MustInherit Class WinFormsPreviewHandler
		...
		<System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Reliability", "CA2000:Dispose objects before losing scope", Justification := "The object remains reachable through the Controls collection which can be disposed at a later time.")> _
