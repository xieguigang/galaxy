...
Namespace ApplicationServices
	...
	''' </summary>
	Public NotInheritable Class ApplicationRestartRecoveryManager
		Private Sub New()
		End Sub
		''' <summary>
		...
		Public Shared Sub RegisterForApplicationRecovery(settings As RecoverySettings)
		...
		Public Shared Sub UnregisterApplicationRecovery()
			CoreHelpers.ThrowIfNotVista()
		...
		Public Shared Sub UnregisterApplicationRestart()
			CoreHelpers.ThrowIfNotVista()
		...
		Public Shared Sub ApplicationRecoveryFinished(success As Boolean)
			CoreHelpers.ThrowIfNotVista()
		...
		Public Shared Sub RegisterForApplicationRestart(settings As RestartSettings)
