...
Namespace ApplicationServices
	...
	Public Class BatteryState
		...
		Public Property MaxCharge() As Integer
			...
			End Set
		End Property
		Private m_MaxCharge As Integer
		...
		Public Property CurrentCharge() As Integer
			...
			End Set
		End Property
		Private m_CurrentCharge As Integer
		''' <summary>
		...
		Public Property ChargeRate() As Integer
			...
			End Set
		End Property
		Private m_ChargeRate As Integer
		...
		Public Property EstimatedTimeRemaining() As TimeSpan
			...
			End Set
		End Property
		Private m_EstimatedTimeRemaining As TimeSpan
		...
		Public Property SuggestedCriticalBatteryCharge() As Integer
			Get
				Return m_SuggestedCriticalBatteryCharge
			End Get
			Private Set
				m_SuggestedCriticalBatteryCharge = Value
			End Set
		End Property
		Private m_SuggestedCriticalBatteryCharge As Integer
		...
		Public Property SuggestedBatteryWarningCharge() As Integer
			Get
				Return m_SuggestedBatteryWarningCharge
			End Get
			Private Set
				m_SuggestedBatteryWarningCharge = Value
			End Set
		End Property
		Private m_SuggestedBatteryWarningCharge As Integer
		...
		Public Overrides Function ToString() As String
			Return String.Format(System.Globalization.CultureInfo.InvariantCulture, LocalizedMessages.BatteryStateStringRepresentation, Environment.NewLine, ACOnline, MaxCharge, CurrentCharge, _
