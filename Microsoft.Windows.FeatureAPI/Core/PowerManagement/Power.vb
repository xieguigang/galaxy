...
Namespace ApplicationServices
	Friend NotInheritable Class Power
		Private Sub New()
		End Sub
		Friend Shared Function GetSystemPowerCapabilities() As PowerManagementNativeMethods.SystemPowerCapabilities
		...
		Friend Shared Function GetSystemBatteryState() As PowerManagementNativeMethods.SystemBatteryState
		...
		Friend Shared Function RegisterPowerSettingNotification(handle As IntPtr, powerSetting As Guid) As Integer
