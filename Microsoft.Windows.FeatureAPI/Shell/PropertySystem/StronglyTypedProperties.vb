...
Namespace Shell.PropertySystem
	...
	''' </summary>
	Public MustInherit Class PropertyStoreItems
	...
	Public Partial Class ShellProperties
		...
		Public Class PropertySystem
			Inherits PropertyStoreItems
			Private shellObjectParent As ShellObject
			...
			''' </summary>
			Public ReadOnly Property AcquisitionID() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.AcquisitionID

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of System.Nullable(Of Int32))(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of System.Nullable(Of Int32)))
				End Get
			End Property
			...
			''' </summary>
			Public ReadOnly Property ApplicationName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ApplicationName

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of [String])(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of [String]))
				End Get
			End Property
			...
			''' </summary>
			Public ReadOnly Property Author() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Author
			...
			''' </summary>
			Public ReadOnly Property Capacity() As ShellProperty(Of System.Nullable(Of UInt64))
				Get
					Dim key As PropertyKey = SystemProperties.System.Capacity

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of System.Nullable(Of UInt64))(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of System.Nullable(Of UInt64)))
				End Get
			End Property
			...
			''' </summary>
			Public ReadOnly Property Category() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Category
			...
			''' </summary>
			Public ReadOnly Property Comment() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Comment
			...
			''' </summary>
			Public ReadOnly Property Company() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Company
			...
			''' </summary>
			Public ReadOnly Property ComputerName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ComputerName
			...
			''' </summary>
			Public ReadOnly Property ContainedItems() As ShellProperty(Of IntPtr())
				Get
					Dim key As PropertyKey = SystemProperties.System.ContainedItems

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of IntPtr())(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of IntPtr()))
				End Get
			End Property
			...
			''' </summary>
			Public ReadOnly Property ContentStatus() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ContentStatus
			...
			''' </summary>
			Public ReadOnly Property ContentType() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ContentType
			...
			''' </summary>
			Public ReadOnly Property Copyright() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Copyright
			...
			''' </summary>
			Public ReadOnly Property DateAccessed() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.DateAccessed

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of System.Nullable(Of DateTime))(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of System.Nullable(Of DateTime)))
				End Get
			End Property
			...
			''' </summary>
			Public ReadOnly Property DateAcquired() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.DateAcquired
			...
			''' </summary>
			Public ReadOnly Property DateArchived() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.DateArchived
			...
			''' </summary>
			Public ReadOnly Property DateCompleted() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.DateCompleted
			...
			''' </summary>
			Public ReadOnly Property DateCreated() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.DateCreated
			...
			''' </summary>
			Public ReadOnly Property DateImported() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.DateImported
			...
			''' </summary>
			Public ReadOnly Property DateModified() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.DateModified
			...
			''' </summary>
			Public ReadOnly Property DescriptionID() As ShellProperty(Of [Byte]())
				Get
					Dim key As PropertyKey = SystemProperties.System.DescriptionID

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of [Byte]())(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of [Byte]()))
				End Get
			End Property
			...
			''' </summary>
			Public ReadOnly Property DueDate() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.DueDate
			...
			''' </summary>
			Public ReadOnly Property EndDate() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.EndDate
			...
			''' </summary>
			Public ReadOnly Property FileAllocationSize() As ShellProperty(Of System.Nullable(Of UInt64))
				Get
					Dim key As PropertyKey = SystemProperties.System.FileAllocationSize
			...
			''' </summary>
			Public ReadOnly Property FileAttributes() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.FileAttributes

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of System.Nullable(Of UInt32))(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of System.Nullable(Of UInt32)))
				End Get
			End Property
			...
			''' </summary>
			Public ReadOnly Property FileCount() As ShellProperty(Of System.Nullable(Of UInt64))
				Get
					Dim key As PropertyKey = SystemProperties.System.FileCount
			...
			''' </summary>
			Public ReadOnly Property FileDescription() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.FileDescription
			...
			''' </summary>
			Public ReadOnly Property FileExtension() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.FileExtension
			...
			''' </summary>
			Public ReadOnly Property FileFRN() As ShellProperty(Of System.Nullable(Of UInt64))
				Get
					Dim key As PropertyKey = SystemProperties.System.FileFRN
			...
			''' </summary>
			Public ReadOnly Property FileName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.FileName
			...
			''' </summary>
			Public ReadOnly Property FileOwner() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.FileOwner
			...
			''' </summary>
			Public ReadOnly Property FileVersion() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.FileVersion
			...
			''' </summary>
			Public ReadOnly Property FindData() As ShellProperty(Of [Byte]())
				Get
					Dim key As PropertyKey = SystemProperties.System.FindData
			...
			''' </summary>
			Public ReadOnly Property FlagColor() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.FlagColor

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of System.Nullable(Of UInt16))(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of System.Nullable(Of UInt16)))
				End Get
			End Property
			...
			''' </summary>
			Public ReadOnly Property FlagColorText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.FlagColorText
			...
			''' </summary>
			Public ReadOnly Property FlagStatus() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.FlagStatus
			...
			''' </summary>
			Public ReadOnly Property FlagStatusText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.FlagStatusText
			...
			''' </summary>
			Public ReadOnly Property FreeSpace() As ShellProperty(Of System.Nullable(Of UInt64))
				Get
					Dim key As PropertyKey = SystemProperties.System.FreeSpace
			...
			''' </summary>
			Public ReadOnly Property FullText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.FullText
			...
			''' </summary>
			Public ReadOnly Property IdentityProperty() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.IdentityProperty
			...
			''' </summary>
			Public ReadOnly Property ImageParsingName() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.ImageParsingName
			...
			''' </summary>
			Public ReadOnly Property Importance() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Importance
			...
			''' </summary>
			Public ReadOnly Property ImportanceText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ImportanceText
			...
			''' </summary>
			Public ReadOnly Property InfoTipText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.InfoTipText
			...
			''' </summary>
			Public ReadOnly Property InternalName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.InternalName
			...
			''' </summary>
			Public ReadOnly Property IsAttachment() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.IsAttachment

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of System.Nullable(Of [Boolean]))(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of System.Nullable(Of [Boolean])))
				End Get
			End Property
			...
			''' </summary>
			Public ReadOnly Property IsDefaultNonOwnerSaveLocation() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.IsDefaultNonOwnerSaveLocation
			...
			''' </summary>
			Public ReadOnly Property IsDefaultSaveLocation() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.IsDefaultSaveLocation
			...
			''' </summary>
			Public ReadOnly Property IsDeleted() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.IsDeleted
			...
			''' </summary>
			Public ReadOnly Property IsEncrypted() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.IsEncrypted
			...
			''' </summary>
			Public ReadOnly Property IsFlagged() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.IsFlagged
			...
			''' </summary>
			Public ReadOnly Property IsFlaggedComplete() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.IsFlaggedComplete
			...
			''' </summary>
			Public ReadOnly Property IsIncomplete() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.IsIncomplete
			...
			''' </summary>
			Public ReadOnly Property IsLocationSupported() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.IsLocationSupported
			...
			''' </summary>
			Public ReadOnly Property IsPinnedToNamespaceTree() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.IsPinnedToNamespaceTree
			...
			''' </summary>
			Public ReadOnly Property IsRead() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.IsRead
			...
			''' </summary>
			Public ReadOnly Property IsSearchOnlyItem() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.IsSearchOnlyItem
			...
			''' </summary>
			Public ReadOnly Property IsSendToTarget() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.IsSendToTarget
			...
			''' </summary>
			Public ReadOnly Property IsShared() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.IsShared
			...
			''' </summary>
			Public ReadOnly Property ItemAuthors() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.ItemAuthors
			...
			''' </summary>
			Public ReadOnly Property ItemClassType() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ItemClassType
			...
			''' </summary>
			Public ReadOnly Property ItemDate() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.ItemDate
			...
			''' </summary>
			Public ReadOnly Property ItemFolderNameDisplay() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ItemFolderNameDisplay
			...
			''' </summary>
			Public ReadOnly Property ItemFolderPathDisplay() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ItemFolderPathDisplay
			...
			''' </summary>
			Public ReadOnly Property ItemFolderPathDisplayNarrow() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ItemFolderPathDisplayNarrow
			...
			''' </summary>
			Public ReadOnly Property ItemName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ItemName
			...
			''' </summary>
			Public ReadOnly Property ItemNameDisplay() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ItemNameDisplay
			...
			''' </summary>
			Public ReadOnly Property ItemNamePrefix() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ItemNamePrefix
			...
			''' </summary>
			Public ReadOnly Property ItemParticipants() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.ItemParticipants
			...
			''' </summary>
			Public ReadOnly Property ItemPathDisplay() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ItemPathDisplay
			...
			''' </summary>
			Public ReadOnly Property ItemPathDisplayNarrow() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ItemPathDisplayNarrow
			...
			''' </summary>
			Public ReadOnly Property ItemType() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ItemType
			...
			''' </summary>
			Public ReadOnly Property ItemTypeText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ItemTypeText
			...
			''' </summary>
			Public ReadOnly Property ItemUrl() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ItemUrl
			...
			''' </summary>
			Public ReadOnly Property Keywords() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Keywords
			...
			''' </summary>
			Public ReadOnly Property Kind() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Kind
			...
			''' </summary>
			Public ReadOnly Property KindText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.KindText
			...
			''' </summary>
			Public ReadOnly Property Language() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Language
			...
			''' </summary>
			Public ReadOnly Property MileageInformation() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.MileageInformation
			...
			''' </summary>
			Public ReadOnly Property MIMEType() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.MIMEType
			...
			''' </summary>
			Public ReadOnly Property NamespaceClsid() As ShellProperty(Of System.Nullable(Of IntPtr))
				Get
					Dim key As PropertyKey = SystemProperties.System.NamespaceClsid

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of System.Nullable(Of IntPtr))(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of System.Nullable(Of IntPtr)))
				End Get
			End Property
			...
			''' </summary>
			Public ReadOnly Property Null() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.Null

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of [Object])(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of [Object]))
				End Get
			End Property
			...
			''' </summary>
			Public ReadOnly Property OfflineAvailability() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.OfflineAvailability
			...
			''' </summary>
			Public ReadOnly Property OfflineStatus() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.OfflineStatus
			...
			''' </summary>
			Public ReadOnly Property OriginalFileName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.OriginalFileName
			...
			''' </summary>
			Public ReadOnly Property OwnerSid() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.OwnerSid
			...
			''' </summary>
			Public ReadOnly Property ParentalRating() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ParentalRating
			...
			''' </summary>
			Public ReadOnly Property ParentalRatingReason() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ParentalRatingReason
			...
			''' </summary>
			Public ReadOnly Property ParentalRatingsOrganization() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ParentalRatingsOrganization
			...
			''' </summary>
			Public ReadOnly Property ParsingBindContext() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.ParsingBindContext
			...
			''' </summary>
			Public ReadOnly Property ParsingName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ParsingName
			...
			''' </summary>
			Public ReadOnly Property ParsingPath() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ParsingPath
			...
			''' </summary>
			Public ReadOnly Property PerceivedType() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.PerceivedType
			...
			''' </summary>
			Public ReadOnly Property PercentFull() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.PercentFull
			...
			''' </summary>
			Public ReadOnly Property Priority() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Priority
			...
			''' </summary>
			Public ReadOnly Property PriorityText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.PriorityText
			...
			''' </summary>
			Public ReadOnly Property Project() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Project
			...
			''' </summary>
			Public ReadOnly Property ProviderItemID() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.ProviderItemID
			...
			''' </summary>
			Public ReadOnly Property Rating() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Rating
			...
			''' </summary>
			Public ReadOnly Property RatingText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.RatingText
			...
			''' </summary>
			Public ReadOnly Property Sensitivity() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Sensitivity
			...
			''' </summary>
			Public ReadOnly Property SensitivityText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.SensitivityText
			...
			''' </summary>
			Public ReadOnly Property SFGAOFlags() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.SFGAOFlags
			...
			''' </summary>
			Public ReadOnly Property SharedWith() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.SharedWith
			...
			''' </summary>
			Public ReadOnly Property ShareUserRating() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.ShareUserRating
			...
			''' </summary>
			Public ReadOnly Property SharingStatus() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.SharingStatus
			...
			''' </summary>
			Public ReadOnly Property SimpleRating() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.SimpleRating
			...
			''' </summary>
			Public ReadOnly Property Size() As ShellProperty(Of System.Nullable(Of UInt64))
				Get
					Dim key As PropertyKey = SystemProperties.System.Size
			...
			''' </summary>
			Public ReadOnly Property SoftwareUsed() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.SoftwareUsed
			...
			''' </summary>
			Public ReadOnly Property SourceItem() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.SourceItem
			...
			''' </summary>
			Public ReadOnly Property StartDate() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.StartDate
			...
			''' </summary>
			Public ReadOnly Property Status() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Status
			...
			''' </summary>
			Public ReadOnly Property Subject() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Subject
			...
			''' </summary>
			Public ReadOnly Property Thumbnail() As ShellProperty(Of System.Nullable(Of IntPtr))
				Get
					Dim key As PropertyKey = SystemProperties.System.Thumbnail
			...
			''' </summary>
			Public ReadOnly Property ThumbnailCacheId() As ShellProperty(Of System.Nullable(Of UInt64))
				Get
					Dim key As PropertyKey = SystemProperties.System.ThumbnailCacheId
			...
			''' </summary>
			Public ReadOnly Property ThumbnailStream() As ShellProperty(Of IStream)
				Get
					Dim key As PropertyKey = SystemProperties.System.ThumbnailStream

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of IStream)(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of IStream))
				End Get
			End Property
			...
			''' </summary>
			Public ReadOnly Property Title() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Title
			...
			''' </summary>
			Public ReadOnly Property TotalFileSize() As ShellProperty(Of System.Nullable(Of UInt64))
				Get
					Dim key As PropertyKey = SystemProperties.System.TotalFileSize
			...
			''' </summary>
			Public ReadOnly Property Trademarks() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Trademarks
			...
			Private internalPropertySystemAppUserModel As PropertySystemAppUserModel
			''' <summary>
			''' System.AppUserModel Properties
			''' </summary>
			Public ReadOnly Property AppUserModel() As PropertySystemAppUserModel
				Get
					If internalPropertySystemAppUserModel Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemAudio As PropertySystemAudio
			''' <summary>
			''' System.Audio Properties
			''' </summary>
			Public ReadOnly Property Audio() As PropertySystemAudio
				Get
					If internalPropertySystemAudio Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemCalendar As PropertySystemCalendar
			''' <summary>
			''' System.Calendar Properties
			''' </summary>
			Public ReadOnly Property Calendar() As PropertySystemCalendar
				Get
					If internalPropertySystemCalendar Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemCommunication As PropertySystemCommunication
			''' <summary>
			''' System.Communication Properties
			''' </summary>
			Public ReadOnly Property Communication() As PropertySystemCommunication
				Get
					If internalPropertySystemCommunication Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemComputer As PropertySystemComputer
			''' <summary>
			''' System.Computer Properties
			''' </summary>
			Public ReadOnly Property Computer() As PropertySystemComputer
				Get
					If internalPropertySystemComputer Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemContact As PropertySystemContact
			''' <summary>
			''' System.Contact Properties
			''' </summary>
			Public ReadOnly Property Contact() As PropertySystemContact
				Get
					If internalPropertySystemContact Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemDevice As PropertySystemDevice
			''' <summary>
			''' System.Device Properties
			''' </summary>
			Public ReadOnly Property Device() As PropertySystemDevice
				Get
					If internalPropertySystemDevice Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemDeviceInterface As PropertySystemDeviceInterface
			''' <summary>
			''' System.DeviceInterface Properties
			''' </summary>
			Public ReadOnly Property DeviceInterface() As PropertySystemDeviceInterface
				Get
					If internalPropertySystemDeviceInterface Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemDevices As PropertySystemDevices
			''' <summary>
			''' System.Devices Properties
			''' </summary>
			Public ReadOnly Property Devices() As PropertySystemDevices
				Get
					If internalPropertySystemDevices Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemDocument As PropertySystemDocument
			''' <summary>
			''' System.Document Properties
			''' </summary>
			Public ReadOnly Property Document() As PropertySystemDocument
				Get
					If internalPropertySystemDocument Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemDRM As PropertySystemDRM
			''' <summary>
			''' System.DRM Properties
			''' </summary>
			Public ReadOnly Property DRM() As PropertySystemDRM
				Get
					If internalPropertySystemDRM Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemGPS As PropertySystemGPS
			''' <summary>
			''' System.GPS Properties
			''' </summary>
			Public ReadOnly Property GPS() As PropertySystemGPS
				Get
					If internalPropertySystemGPS Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemIdentity As PropertySystemIdentity
			''' <summary>
			''' System.Identity Properties
			''' </summary>
			Public ReadOnly Property Identity() As PropertySystemIdentity
				Get
					If internalPropertySystemIdentity Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemIdentityProvider As PropertySystemIdentityProvider
			''' <summary>
			''' System.IdentityProvider Properties
			''' </summary>
			Public ReadOnly Property IdentityProvider() As PropertySystemIdentityProvider
				Get
					If internalPropertySystemIdentityProvider Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemImage As PropertySystemImage
			''' <summary>
			''' System.Image Properties
			''' </summary>
			Public ReadOnly Property Image() As PropertySystemImage
				Get
					If internalPropertySystemImage Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemJournal As PropertySystemJournal
			''' <summary>
			''' System.Journal Properties
			''' </summary>
			Public ReadOnly Property Journal() As PropertySystemJournal
				Get
					If internalPropertySystemJournal Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemLayoutPattern As PropertySystemLayoutPattern
			''' <summary>
			''' System.LayoutPattern Properties
			''' </summary>
			Public ReadOnly Property LayoutPattern() As PropertySystemLayoutPattern
				Get
					If internalPropertySystemLayoutPattern Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemLink As PropertySystemLink
			''' <summary>
			''' System.Link Properties
			''' </summary>
			Public ReadOnly Property Link() As PropertySystemLink
				Get
					If internalPropertySystemLink Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemMedia As PropertySystemMedia
			''' <summary>
			''' System.Media Properties
			''' </summary>
			Public ReadOnly Property Media() As PropertySystemMedia
				Get
					If internalPropertySystemMedia Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemMessage As PropertySystemMessage
			''' <summary>
			''' System.Message Properties
			''' </summary>
			Public ReadOnly Property Message() As PropertySystemMessage
				Get
					If internalPropertySystemMessage Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemMusic As PropertySystemMusic
			''' <summary>
			''' System.Music Properties
			''' </summary>
			Public ReadOnly Property Music() As PropertySystemMusic
				Get
					If internalPropertySystemMusic Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemNote As PropertySystemNote
			''' <summary>
			''' System.Note Properties
			''' </summary>
			Public ReadOnly Property Note() As PropertySystemNote
				Get
					If internalPropertySystemNote Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemPhoto As PropertySystemPhoto
			''' <summary>
			''' System.Photo Properties
			''' </summary>
			Public ReadOnly Property Photo() As PropertySystemPhoto
				Get
					If internalPropertySystemPhoto Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemPropGroup As PropertySystemPropGroup
			''' <summary>
			''' System.PropGroup Properties
			''' </summary>
			Public ReadOnly Property PropGroup() As PropertySystemPropGroup
				Get
					If internalPropertySystemPropGroup Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemPropList As PropertySystemPropList
			''' <summary>
			''' System.PropList Properties
			''' </summary>
			Public ReadOnly Property PropList() As PropertySystemPropList
				Get
					If internalPropertySystemPropList Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemRecordedTV As PropertySystemRecordedTV
			''' <summary>
			''' System.RecordedTV Properties
			''' </summary>
			Public ReadOnly Property RecordedTV() As PropertySystemRecordedTV
				Get
					If internalPropertySystemRecordedTV Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemSearch As PropertySystemSearch
			''' <summary>
			''' System.Search Properties
			''' </summary>
			Public ReadOnly Property Search() As PropertySystemSearch
				Get
					If internalPropertySystemSearch Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemShell As PropertySystemShell
			''' <summary>
			''' System.Shell Properties
			''' </summary>
			Public ReadOnly Property Shell() As PropertySystemShell
				Get
					If internalPropertySystemShell Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemSoftware As PropertySystemSoftware
			''' <summary>
			''' System.Software Properties
			''' </summary>
			Public ReadOnly Property Software() As PropertySystemSoftware
				Get
					If internalPropertySystemSoftware Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemSync As PropertySystemSync
			''' <summary>
			''' System.Sync Properties
			''' </summary>
			Public ReadOnly Property Sync() As PropertySystemSync
				Get
					If internalPropertySystemSync Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemTask As PropertySystemTask
			''' <summary>
			''' System.Task Properties
			''' </summary>
			Public ReadOnly Property Task() As PropertySystemTask
				Get
					If internalPropertySystemTask Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemVideo As PropertySystemVideo
			''' <summary>
			''' System.Video Properties
			''' </summary>
			Public ReadOnly Property Video() As PropertySystemVideo
				Get
					If internalPropertySystemVideo Is Nothing Then
				...
				End Get
			End Property
			Private internalPropertySystemVolume As PropertySystemVolume
			''' <summary>
			''' System.Volume Properties
			''' </summary>
			Public ReadOnly Property Volume() As PropertySystemVolume
				Get
					If internalPropertySystemVolume Is Nothing Then
		...
		''' System.AppUserModel Properties
		''' </summary>
		Public Class PropertySystemAppUserModel
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property ExcludeFromShowInNewInstall() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.AppUserModel.ExcludeFromShowInNewInstall
			...
			''' </summary>
			Public ReadOnly Property ID() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.AppUserModel.ID
			...
			''' </summary>
			Public ReadOnly Property IsDestinationListSeparator() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.AppUserModel.IsDestinationListSeparator
			...
			''' </summary>
			Public ReadOnly Property PreventPinning() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.AppUserModel.PreventPinning
			...
			''' </summary>
			Public ReadOnly Property RelaunchCommand() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.AppUserModel.RelaunchCommand
			...
			''' </summary>
			Public ReadOnly Property RelaunchDisplayNameResource() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.AppUserModel.RelaunchDisplayNameResource
			...
			''' </summary>
			Public ReadOnly Property RelaunchIconResource() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.AppUserModel.RelaunchIconResource
		...
		''' System.Audio Properties
		''' </summary>
		Public Class PropertySystemAudio
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property ChannelCount() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Audio.ChannelCount
			...
			''' </summary>
			Public ReadOnly Property Compression() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Audio.Compression
			...
			''' </summary>
			Public ReadOnly Property EncodingBitrate() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Audio.EncodingBitrate
			...
			''' </summary>
			Public ReadOnly Property Format() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Audio.Format
			...
			''' </summary>
			Public ReadOnly Property IsVariableBitrate() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Audio.IsVariableBitrate
			...
			''' </summary>
			Public ReadOnly Property PeakValue() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Audio.PeakValue
			...
			''' </summary>
			Public ReadOnly Property SampleRate() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Audio.SampleRate
			...
			''' </summary>
			Public ReadOnly Property SampleSize() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Audio.SampleSize
			...
			''' </summary>
			Public ReadOnly Property StreamName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Audio.StreamName
			...
			''' </summary>
			Public ReadOnly Property StreamNumber() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Audio.StreamNumber
		...
		''' System.Calendar Properties
		''' </summary>
		Public Class PropertySystemCalendar
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property Duration() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Calendar.Duration
			...
			''' </summary>
			Public ReadOnly Property IsOnline() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Calendar.IsOnline
			...
			''' </summary>
			Public ReadOnly Property IsRecurring() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Calendar.IsRecurring
			...
			''' </summary>
			Public ReadOnly Property Location() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Calendar.Location
			...
			''' </summary>
			Public ReadOnly Property OptionalAttendeeAddresses() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Calendar.OptionalAttendeeAddresses
			...
			''' </summary>
			Public ReadOnly Property OptionalAttendeeNames() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Calendar.OptionalAttendeeNames
			...
			''' </summary>
			Public ReadOnly Property OrganizerAddress() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Calendar.OrganizerAddress
			...
			''' </summary>
			Public ReadOnly Property OrganizerName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Calendar.OrganizerName
			...
			''' </summary>
			Public ReadOnly Property ReminderTime() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.Calendar.ReminderTime
			...
			''' </summary>
			Public ReadOnly Property RequiredAttendeeAddresses() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Calendar.RequiredAttendeeAddresses
			...
			''' </summary>
			Public ReadOnly Property RequiredAttendeeNames() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Calendar.RequiredAttendeeNames
			...
			''' </summary>
			Public ReadOnly Property Resources() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Calendar.Resources
			...
			''' </summary>
			Public ReadOnly Property ResponseStatus() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Calendar.ResponseStatus
			...
			''' </summary>
			Public ReadOnly Property ShowTimeAs() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Calendar.ShowTimeAs
			...
			''' </summary>
			Public ReadOnly Property ShowTimeAsText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Calendar.ShowTimeAsText
		...
		''' System.Communication Properties
		''' </summary>
		Public Class PropertySystemCommunication
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property AccountName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Communication.AccountName
			...
			''' </summary>
			Public ReadOnly Property DateItemExpires() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.Communication.DateItemExpires
			...
			''' </summary>
			Public ReadOnly Property FollowUpIconIndex() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Communication.FollowUpIconIndex
			...
			''' </summary>
			Public ReadOnly Property HeaderItem() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Communication.HeaderItem
			...
			''' </summary>
			Public ReadOnly Property PolicyTag() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Communication.PolicyTag
			...
			''' </summary>
			Public ReadOnly Property SecurityFlags() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Communication.SecurityFlags
			...
			''' </summary>
			Public ReadOnly Property Suffix() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Communication.Suffix
			...
			''' </summary>
			Public ReadOnly Property TaskStatus() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Communication.TaskStatus
			...
			''' </summary>
			Public ReadOnly Property TaskStatusText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Communication.TaskStatusText
		...
		''' System.Computer Properties
		''' </summary>
		Public Class PropertySystemComputer
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property DecoratedFreeSpace() As ShellProperty(Of UInt64())
				Get
					Dim key As PropertyKey = SystemProperties.System.Computer.DecoratedFreeSpace

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of UInt64())(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of UInt64()))
				End Get
			End Property
			#End Region
		...
		''' System.Contact Properties
		''' </summary>
		Public Class PropertySystemContact
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property Anniversary() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.Anniversary
			...
			''' </summary>
			Public ReadOnly Property AssistantName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.AssistantName
			...
			''' </summary>
			Public ReadOnly Property AssistantTelephone() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.AssistantTelephone
			...
			''' </summary>
			Public ReadOnly Property Birthday() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.Birthday
			...
			''' </summary>
			Public ReadOnly Property BusinessAddress() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.BusinessAddress
			...
			''' </summary>
			Public ReadOnly Property BusinessAddressCity() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.BusinessAddressCity
			...
			''' </summary>
			Public ReadOnly Property BusinessAddressCountry() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.BusinessAddressCountry
			...
			''' </summary>
			Public ReadOnly Property BusinessAddressPostalCode() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.BusinessAddressPostalCode
			...
			''' </summary>
			Public ReadOnly Property BusinessAddressPostOfficeBox() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.BusinessAddressPostOfficeBox
			...
			''' </summary>
			Public ReadOnly Property BusinessAddressState() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.BusinessAddressState
			...
			''' </summary>
			Public ReadOnly Property BusinessAddressStreet() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.BusinessAddressStreet
			...
			''' </summary>
			Public ReadOnly Property BusinessFaxNumber() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.BusinessFaxNumber
			...
			''' </summary>
			Public ReadOnly Property BusinessHomepage() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.BusinessHomepage
			...
			''' </summary>
			Public ReadOnly Property BusinessTelephone() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.BusinessTelephone
			...
			''' </summary>
			Public ReadOnly Property CallbackTelephone() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.CallbackTelephone
			...
			''' </summary>
			Public ReadOnly Property CarTelephone() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.CarTelephone
			...
			''' </summary>
			Public ReadOnly Property Children() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.Children
			...
			''' </summary>
			Public ReadOnly Property CompanyMainTelephone() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.CompanyMainTelephone
			...
			''' </summary>
			Public ReadOnly Property Department() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.Department
			...
			''' </summary>
			Public ReadOnly Property EmailAddress() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.EmailAddress
			...
			''' </summary>
			Public ReadOnly Property EmailAddress2() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.EmailAddress2
			...
			''' </summary>
			Public ReadOnly Property EmailAddress3() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.EmailAddress3
			...
			''' </summary>
			Public ReadOnly Property EmailAddresses() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.EmailAddresses
			...
			''' </summary>
			Public ReadOnly Property EmailName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.EmailName
			...
			''' </summary>
			Public ReadOnly Property FileAsName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.FileAsName
			...
			''' </summary>
			Public ReadOnly Property FirstName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.FirstName
			...
			''' </summary>
			Public ReadOnly Property FullName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.FullName
			...
			''' </summary>
			Public ReadOnly Property Gender() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.Gender
			...
			''' </summary>
			Public ReadOnly Property GenderValue() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.GenderValue
			...
			''' </summary>
			Public ReadOnly Property Hobbies() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.Hobbies
			...
			''' </summary>
			Public ReadOnly Property HomeAddress() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.HomeAddress
			...
			''' </summary>
			Public ReadOnly Property HomeAddressCity() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.HomeAddressCity
			...
			''' </summary>
			Public ReadOnly Property HomeAddressCountry() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.HomeAddressCountry
			...
			''' </summary>
			Public ReadOnly Property HomeAddressPostalCode() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.HomeAddressPostalCode
			...
			''' </summary>
			Public ReadOnly Property HomeAddressPostOfficeBox() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.HomeAddressPostOfficeBox
			...
			''' </summary>
			Public ReadOnly Property HomeAddressState() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.HomeAddressState
			...
			''' </summary>
			Public ReadOnly Property HomeAddressStreet() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.HomeAddressStreet
			...
			''' </summary>
			Public ReadOnly Property HomeFaxNumber() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.HomeFaxNumber
			...
			''' </summary>
			Public ReadOnly Property HomeTelephone() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.HomeTelephone
			...
			''' </summary>
			Public ReadOnly Property IMAddress() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.IMAddress
			...
			''' </summary>
			Public ReadOnly Property Initials() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.Initials
			...
			''' </summary>
			Public ReadOnly Property JobTitle() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.JobTitle
			...
			''' </summary>
			Public ReadOnly Property Label() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.Label
			...
			''' </summary>
			Public ReadOnly Property LastName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.LastName
			...
			''' </summary>
			Public ReadOnly Property MailingAddress() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.MailingAddress
			...
			''' </summary>
			Public ReadOnly Property MiddleName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.MiddleName
			...
			''' </summary>
			Public ReadOnly Property MobileTelephone() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.MobileTelephone
			...
			''' </summary>
			Public ReadOnly Property Nickname() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.Nickname
			...
			''' </summary>
			Public ReadOnly Property OfficeLocation() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.OfficeLocation
			...
			''' </summary>
			Public ReadOnly Property OtherAddress() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.OtherAddress
			...
			''' </summary>
			Public ReadOnly Property OtherAddressCity() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.OtherAddressCity
			...
			''' </summary>
			Public ReadOnly Property OtherAddressCountry() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.OtherAddressCountry
			...
			''' </summary>
			Public ReadOnly Property OtherAddressPostalCode() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.OtherAddressPostalCode
			...
			''' </summary>
			Public ReadOnly Property OtherAddressPostOfficeBox() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.OtherAddressPostOfficeBox
			...
			''' </summary>
			Public ReadOnly Property OtherAddressState() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.OtherAddressState
			...
			''' </summary>
			Public ReadOnly Property OtherAddressStreet() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.OtherAddressStreet
			...
			''' </summary>
			Public ReadOnly Property PagerTelephone() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.PagerTelephone
			...
			''' </summary>
			Public ReadOnly Property PersonalTitle() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.PersonalTitle
			...
			''' </summary>
			Public ReadOnly Property PrimaryAddressCity() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.PrimaryAddressCity
			...
			''' </summary>
			Public ReadOnly Property PrimaryAddressCountry() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.PrimaryAddressCountry
			...
			''' </summary>
			Public ReadOnly Property PrimaryAddressPostalCode() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.PrimaryAddressPostalCode
			...
			''' </summary>
			Public ReadOnly Property PrimaryAddressPostOfficeBox() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.PrimaryAddressPostOfficeBox
			...
			''' </summary>
			Public ReadOnly Property PrimaryAddressState() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.PrimaryAddressState
			...
			''' </summary>
			Public ReadOnly Property PrimaryAddressStreet() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.PrimaryAddressStreet
			...
			''' </summary>
			Public ReadOnly Property PrimaryEmailAddress() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.PrimaryEmailAddress
			...
			''' </summary>
			Public ReadOnly Property PrimaryTelephone() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.PrimaryTelephone
			...
			''' </summary>
			Public ReadOnly Property Profession() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.Profession
			...
			''' </summary>
			Public ReadOnly Property SpouseName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.SpouseName
			...
			Public ReadOnly Property Suffix() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.Suffix
			...
			''' </summary>
			Public ReadOnly Property TelexNumber() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.TelexNumber
			...
			''' </summary>
			Public ReadOnly Property TTYTDDTelephone() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.TTYTDDTelephone
			...
			''' </summary>
			Public ReadOnly Property Webpage() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.Webpage
			...
			#Region "sub-namespaces"
			Private internalPropertyContactJA As PropertyContactJA
			''' <summary>
			''' Contact.JA Properties
			''' </summary>
			Public ReadOnly Property JA() As PropertyContactJA
				Get
					If internalPropertyContactJA Is Nothing Then
		...
		''' Contact.JA Properties
		''' </summary>
		Public Class PropertyContactJA
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property CompanyNamePhonetic() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.JA.CompanyNamePhonetic
			...
			''' </summary>
			Public ReadOnly Property FirstNamePhonetic() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.JA.FirstNamePhonetic
			...
			''' </summary>
			Public ReadOnly Property LastNamePhonetic() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Contact.JA.LastNamePhonetic
		...
		''' System.Device Properties
		''' </summary>
		Public Class PropertySystemDevice
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property PrinterUrl() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Device.PrinterUrl
		...
		''' System.DeviceInterface Properties
		''' </summary>
		Public Class PropertySystemDeviceInterface
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property PrinterDriverDirectory() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.DeviceInterface.PrinterDriverDirectory
			...
			''' </summary>
			Public ReadOnly Property PrinterDriverName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.DeviceInterface.PrinterDriverName
			...
			''' </summary>
			Public ReadOnly Property PrinterName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.DeviceInterface.PrinterName
			...
			''' </summary>
			Public ReadOnly Property PrinterPortName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.DeviceInterface.PrinterPortName
		...
		''' System.Devices Properties
		''' </summary>
		Public Class PropertySystemDevices
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property BatteryLife() As ShellProperty(Of System.Nullable(Of [Byte]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.BatteryLife

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of System.Nullable(Of [Byte]))(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of System.Nullable(Of [Byte])))
				End Get
			End Property
			...
			''' </summary>
			Public ReadOnly Property BatteryPlusCharging() As ShellProperty(Of System.Nullable(Of [Byte]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.BatteryPlusCharging
			...
			''' </summary>
			Public ReadOnly Property BatteryPlusChargingText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.BatteryPlusChargingText
			...
			Public ReadOnly Property Category() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.Category
			...
			''' </summary>
			Public ReadOnly Property CategoryGroup() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.CategoryGroup
			...
			''' </summary>
			Public ReadOnly Property CategoryPlural() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.CategoryPlural
			...
			''' </summary>
			Public ReadOnly Property ChargingState() As ShellProperty(Of System.Nullable(Of [Byte]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.ChargingState
			...
			''' </summary>
			Public ReadOnly Property Connected() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.Connected
			...
			''' </summary>
			Public ReadOnly Property ContainerId() As ShellProperty(Of System.Nullable(Of IntPtr))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.ContainerId
			...
			''' </summary>
			Public ReadOnly Property DefaultTooltip() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.DefaultTooltip
			...
			''' </summary>
			Public ReadOnly Property DeviceDescription1() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.DeviceDescription1
			...
			''' </summary>
			Public ReadOnly Property DeviceDescription2() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.DeviceDescription2
			...
			''' </summary>
			Public ReadOnly Property DiscoveryMethod() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.DiscoveryMethod
			...
			''' </summary>
			Public ReadOnly Property FriendlyName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.FriendlyName
			...
			''' </summary>
			Public ReadOnly Property FunctionPaths() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.FunctionPaths
			...
			''' </summary>
			Public ReadOnly Property InterfacePaths() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.InterfacePaths
			...
			''' </summary>
			Public ReadOnly Property IsDefault() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.IsDefault
			...
			''' </summary>
			Public ReadOnly Property IsNetworkConnected() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.IsNetworkConnected
			...
			Public ReadOnly Property IsShared() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.IsShared
			...
			''' </summary>
			Public ReadOnly Property IsSoftwareInstalling() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.IsSoftwareInstalling
			...
			''' </summary>
			Public ReadOnly Property LaunchDeviceStageFromExplorer() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.LaunchDeviceStageFromExplorer
			...
			''' </summary>
			Public ReadOnly Property LocalMachine() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.LocalMachine
			...
			''' </summary>
			Public ReadOnly Property Manufacturer() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.Manufacturer
			...
			''' </summary>
			Public ReadOnly Property MissedCalls() As ShellProperty(Of System.Nullable(Of [Byte]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.MissedCalls
			...
			''' </summary>
			Public ReadOnly Property ModelName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.ModelName
			...
			''' </summary>
			Public ReadOnly Property ModelNumber() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.ModelNumber
			...
			''' </summary>
			Public ReadOnly Property NetworkedTooltip() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.NetworkedTooltip
			...
			''' </summary>
			Public ReadOnly Property NetworkName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.NetworkName
			...
			''' </summary>
			Public ReadOnly Property NetworkType() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.NetworkType
			...
			''' </summary>
			Public ReadOnly Property NewPictures() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.NewPictures
			...
			''' </summary>
			Public ReadOnly Property Notification() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.Notification
			...
			''' </summary>
			Public ReadOnly Property NotificationStore() As ShellProperty(Of System.Nullable(Of IntPtr))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.NotificationStore
			...
			''' </summary>
			Public ReadOnly Property NotWorkingProperly() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.NotWorkingProperly
			...
			''' </summary>
			Public ReadOnly Property Paired() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.Paired
			...
			''' </summary>
			Public ReadOnly Property PrimaryCategory() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.PrimaryCategory
			...
			''' </summary>
			Public ReadOnly Property Roaming() As ShellProperty(Of System.Nullable(Of [Byte]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.Roaming
			...
			''' </summary>
			Public ReadOnly Property SafeRemovalRequired() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.SafeRemovalRequired
			...
			''' </summary>
			Public ReadOnly Property SharedTooltip() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.SharedTooltip
			...
			''' </summary>
			Public ReadOnly Property SignalStrength() As ShellProperty(Of System.Nullable(Of [Byte]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.SignalStrength
			...
			''' </summary>
			Public ReadOnly Property Status1() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.Status1
			...
			''' </summary>
			Public ReadOnly Property Status2() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.Status2
			...
			''' </summary>
			Public ReadOnly Property StorageCapacity() As ShellProperty(Of System.Nullable(Of UInt64))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.StorageCapacity
			...
			''' </summary>
			Public ReadOnly Property StorageFreeSpace() As ShellProperty(Of System.Nullable(Of UInt64))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.StorageFreeSpace
			...
			''' </summary>
			Public ReadOnly Property StorageFreeSpacePercent() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.StorageFreeSpacePercent
			...
			''' </summary>
			Public ReadOnly Property TextMessages() As ShellProperty(Of System.Nullable(Of [Byte]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.TextMessages
			...
			''' </summary>
			Public ReadOnly Property Voicemail() As ShellProperty(Of System.Nullable(Of [Byte]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.Voicemail
			...
			#Region "sub-namespaces"
			Private internalPropertyDevicesNotifications As PropertyDevicesNotifications
			''' <summary>
			''' Devices.Notifications Properties
			''' </summary>
			Public ReadOnly Property Notifications() As PropertyDevicesNotifications
				Get
					If internalPropertyDevicesNotifications Is Nothing Then
		...
		''' Devices.Notifications Properties
		''' </summary>
		Public Class PropertyDevicesNotifications
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property LowBattery() As ShellProperty(Of System.Nullable(Of [Byte]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.Notifications.LowBattery
			...
			''' </summary>
			Public ReadOnly Property MissedCall() As ShellProperty(Of System.Nullable(Of [Byte]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.Notifications.MissedCall
			...
			''' </summary>
			Public ReadOnly Property NewMessage() As ShellProperty(Of System.Nullable(Of [Byte]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.Notifications.NewMessage
			...
			''' </summary>
			Public ReadOnly Property NewVoicemail() As ShellProperty(Of System.Nullable(Of [Byte]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.Notifications.NewVoicemail
			...
			''' </summary>
			Public ReadOnly Property StorageFull() As ShellProperty(Of System.Nullable(Of UInt64))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.Notifications.StorageFull
			...
			''' </summary>
			Public ReadOnly Property StorageFullLinkText() As ShellProperty(Of System.Nullable(Of UInt64))
				Get
					Dim key As PropertyKey = SystemProperties.System.Devices.Notifications.StorageFullLinkText
		...
		''' System.Document Properties
		''' </summary>
		Public Class PropertySystemDocument
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property ByteCount() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.ByteCount
			...
			''' </summary>
			Public ReadOnly Property CharacterCount() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.CharacterCount
			...
			''' </summary>
			Public ReadOnly Property ClientID() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.ClientID
			...
			''' </summary>
			Public ReadOnly Property Contributor() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.Contributor
			...
			Public ReadOnly Property DateCreated() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.DateCreated
			...
			''' </summary>
			Public ReadOnly Property DatePrinted() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.DatePrinted
			...
			''' </summary>
			Public ReadOnly Property DateSaved() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.DateSaved
			...
			''' </summary>
			Public ReadOnly Property Division() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.Division
			...
			''' </summary>
			Public ReadOnly Property DocumentID() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.DocumentID
			...
			''' </summary>
			Public ReadOnly Property HiddenSlideCount() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.HiddenSlideCount
			...
			''' </summary>
			Public ReadOnly Property LastAuthor() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.LastAuthor
			...
			''' </summary>
			Public ReadOnly Property LineCount() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.LineCount
			...
			''' </summary>
			Public ReadOnly Property Manager() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.Manager
			...
			''' </summary>
			Public ReadOnly Property MultimediaClipCount() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.MultimediaClipCount
			...
			''' </summary>
			Public ReadOnly Property NoteCount() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.NoteCount
			...
			''' </summary>
			Public ReadOnly Property PageCount() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.PageCount
			...
			''' </summary>
			Public ReadOnly Property ParagraphCount() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.ParagraphCount
			...
			''' </summary>
			Public ReadOnly Property PresentationFormat() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.PresentationFormat
			...
			''' </summary>
			Public ReadOnly Property RevisionNumber() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.RevisionNumber
			...
			''' </summary>
			Public ReadOnly Property Security() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.Security
			...
			''' </summary>
			Public ReadOnly Property SlideCount() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.SlideCount
			...
			''' </summary>
			Public ReadOnly Property Template() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.Template
			...
			''' </summary>
			Public ReadOnly Property TotalEditingTime() As ShellProperty(Of System.Nullable(Of UInt64))
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.TotalEditingTime
			...
			''' </summary>
			Public ReadOnly Property Version() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.Version
			...
			''' </summary>
			Public ReadOnly Property WordCount() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Document.WordCount
		...
		''' System.DRM Properties
		''' </summary>
		Public Class PropertySystemDRM
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property DatePlayExpires() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.DRM.DatePlayExpires
			...
			''' </summary>
			Public ReadOnly Property DatePlayStarts() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.DRM.DatePlayStarts
			...
			''' </summary>
			Public ReadOnly Property Description() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.DRM.Description
			...
			''' </summary>
			Public ReadOnly Property IsProtected() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.DRM.IsProtected
			...
			''' </summary>
			Public ReadOnly Property PlayCount() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.DRM.PlayCount
		...
		''' System.GPS Properties
		''' </summary>
		Public Class PropertySystemGPS
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property Altitude() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.Altitude

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of System.Nullable(Of [Double]))(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of System.Nullable(Of [Double])))
				End Get
			End Property
			...
			''' </summary>
			Public ReadOnly Property AltitudeDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.AltitudeDenominator
			...
			''' </summary>
			Public ReadOnly Property AltitudeNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.AltitudeNumerator
			...
			''' </summary>
			Public ReadOnly Property AltitudeRef() As ShellProperty(Of System.Nullable(Of [Byte]))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.AltitudeRef
			...
			''' </summary>
			Public ReadOnly Property AreaInformation() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.AreaInformation
			...
			''' </summary>
			Public ReadOnly Property [Date]() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.[Date]
			...
			''' </summary>
			Public ReadOnly Property DestinationBearing() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DestinationBearing
			...
			''' </summary>
			Public ReadOnly Property DestinationBearingDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DestinationBearingDenominator
			...
			''' </summary>
			Public ReadOnly Property DestinationBearingNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DestinationBearingNumerator
			...
			''' </summary>
			Public ReadOnly Property DestinationBearingRef() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DestinationBearingRef
			...
			''' </summary>
			Public ReadOnly Property DestinationDistance() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DestinationDistance
			...
			''' </summary>
			Public ReadOnly Property DestinationDistanceDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DestinationDistanceDenominator
			...
			''' </summary>
			Public ReadOnly Property DestinationDistanceNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DestinationDistanceNumerator
			...
			''' </summary>
			Public ReadOnly Property DestinationDistanceRef() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DestinationDistanceRef
			...
			''' </summary>
			Public ReadOnly Property DestinationLatitude() As ShellProperty(Of [Double]())
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DestinationLatitude

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of [Double]())(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of [Double]()))
				End Get
			End Property
			...
			''' </summary>
			Public ReadOnly Property DestinationLatitudeDenominator() As ShellProperty(Of UInt32())
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DestinationLatitudeDenominator

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of UInt32())(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of UInt32()))
				End Get
			End Property
			...
			''' </summary>
			Public ReadOnly Property DestinationLatitudeNumerator() As ShellProperty(Of UInt32())
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DestinationLatitudeNumerator
			...
			''' </summary>
			Public ReadOnly Property DestinationLatitudeRef() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DestinationLatitudeRef
			...
			''' </summary>
			Public ReadOnly Property DestinationLongitude() As ShellProperty(Of [Double]())
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DestinationLongitude
			...
			''' </summary>
			Public ReadOnly Property DestinationLongitudeDenominator() As ShellProperty(Of UInt32())
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DestinationLongitudeDenominator
			...
			''' </summary>
			Public ReadOnly Property DestinationLongitudeNumerator() As ShellProperty(Of UInt32())
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DestinationLongitudeNumerator
			...
			''' </summary>
			Public ReadOnly Property DestinationLongitudeRef() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DestinationLongitudeRef
			...
			''' </summary>
			Public ReadOnly Property Differential() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.Differential
			...
			''' </summary>
			Public ReadOnly Property DOP() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DOP
			...
			''' </summary>
			Public ReadOnly Property DOPDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DOPDenominator
			...
			''' </summary>
			Public ReadOnly Property DOPNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.DOPNumerator
			...
			''' </summary>
			Public ReadOnly Property ImageDirection() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.ImageDirection
			...
			''' </summary>
			Public ReadOnly Property ImageDirectionDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.ImageDirectionDenominator
			...
			''' </summary>
			Public ReadOnly Property ImageDirectionNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.ImageDirectionNumerator
			...
			''' </summary>
			Public ReadOnly Property ImageDirectionRef() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.ImageDirectionRef
			...
			''' </summary>
			Public ReadOnly Property Latitude() As ShellProperty(Of [Double]())
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.Latitude
			...
			''' </summary>
			Public ReadOnly Property LatitudeDenominator() As ShellProperty(Of UInt32())
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.LatitudeDenominator
			...
			''' </summary>
			Public ReadOnly Property LatitudeNumerator() As ShellProperty(Of UInt32())
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.LatitudeNumerator
			...
			''' </summary>
			Public ReadOnly Property LatitudeRef() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.LatitudeRef
			...
			''' </summary>
			Public ReadOnly Property Longitude() As ShellProperty(Of [Double]())
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.Longitude
			...
			''' </summary>
			Public ReadOnly Property LongitudeDenominator() As ShellProperty(Of UInt32())
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.LongitudeDenominator
			...
			''' </summary>
			Public ReadOnly Property LongitudeNumerator() As ShellProperty(Of UInt32())
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.LongitudeNumerator
			...
			''' </summary>
			Public ReadOnly Property LongitudeRef() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.LongitudeRef
			...
			''' </summary>
			Public ReadOnly Property MapDatum() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.MapDatum
			...
			''' </summary>
			Public ReadOnly Property MeasureMode() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.MeasureMode
			...
			''' </summary>
			Public ReadOnly Property ProcessingMethod() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.ProcessingMethod
			...
			''' </summary>
			Public ReadOnly Property Satellites() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.Satellites
			...
			''' </summary>
			Public ReadOnly Property Speed() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.Speed
			...
			''' </summary>
			Public ReadOnly Property SpeedDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.SpeedDenominator
			...
			''' </summary>
			Public ReadOnly Property SpeedNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.SpeedNumerator
			...
			''' </summary>
			Public ReadOnly Property SpeedRef() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.SpeedRef
			...
			Public ReadOnly Property Status() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.Status
			...
			''' </summary>
			Public ReadOnly Property Track() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.Track
			...
			''' </summary>
			Public ReadOnly Property TrackDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.TrackDenominator
			...
			''' </summary>
			Public ReadOnly Property TrackNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.TrackNumerator
			...
			''' </summary>
			Public ReadOnly Property TrackRef() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.TrackRef
			...
			''' </summary>
			Public ReadOnly Property VersionID() As ShellProperty(Of [Byte]())
				Get
					Dim key As PropertyKey = SystemProperties.System.GPS.VersionID
		...
		''' System.Identity Properties
		''' </summary>
		Public Class PropertySystemIdentity
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property Blob() As ShellProperty(Of [Byte]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Identity.Blob
			...
			''' </summary>
			Public ReadOnly Property DisplayName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Identity.DisplayName
			...
			''' </summary>
			Public ReadOnly Property IsMeIdentity() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Identity.IsMeIdentity
			...
			Public ReadOnly Property PrimaryEmailAddress() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Identity.PrimaryEmailAddress
			...
			''' </summary>
			Public ReadOnly Property ProviderID() As ShellProperty(Of System.Nullable(Of IntPtr))
				Get
					Dim key As PropertyKey = SystemProperties.System.Identity.ProviderID
			...
			''' </summary>
			Public ReadOnly Property UniqueID() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Identity.UniqueID
			...
			''' </summary>
			Public ReadOnly Property UserName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Identity.UserName
		...
		''' System.IdentityProvider Properties
		''' </summary>
		Public Class PropertySystemIdentityProvider
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property Name() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.IdentityProvider.Name
			...
			''' </summary>
			Public ReadOnly Property Picture() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.IdentityProvider.Picture
		...
		''' System.Image Properties
		''' </summary>
		Public Class PropertySystemImage
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property BitDepth() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Image.BitDepth
			...
			''' </summary>
			Public ReadOnly Property ColorSpace() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Image.ColorSpace
			...
			''' </summary>
			Public ReadOnly Property CompressedBitsPerPixel() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Image.CompressedBitsPerPixel
			...
			''' </summary>
			Public ReadOnly Property CompressedBitsPerPixelDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Image.CompressedBitsPerPixelDenominator
			...
			''' </summary>
			Public ReadOnly Property CompressedBitsPerPixelNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Image.CompressedBitsPerPixelNumerator
			...
			''' </summary>
			Public ReadOnly Property Compression() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Image.Compression
			...
			''' </summary>
			Public ReadOnly Property CompressionText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Image.CompressionText
			...
			''' </summary>
			Public ReadOnly Property Dimensions() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Image.Dimensions
			...
			''' </summary>
			Public ReadOnly Property HorizontalResolution() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Image.HorizontalResolution
			...
			''' </summary>
			Public ReadOnly Property HorizontalSize() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Image.HorizontalSize
			...
			''' </summary>
			Public ReadOnly Property ImageID() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Image.ImageID
			...
			''' </summary>
			Public ReadOnly Property ResolutionUnit() As ShellProperty(Of System.Nullable(Of Int16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Image.ResolutionUnit

					If Not hashtable.ContainsKey(key) Then
						hashtable.Add(key, shellObjectParent.Properties.CreateTypedProperty(Of System.Nullable(Of Int16))(key))
					End If

					Return TryCast(hashtable(key), ShellProperty(Of System.Nullable(Of Int16)))
				End Get
			End Property
			...
			''' </summary>
			Public ReadOnly Property VerticalResolution() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Image.VerticalResolution
			...
			''' </summary>
			Public ReadOnly Property VerticalSize() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Image.VerticalSize
		...
		''' System.Journal Properties
		''' </summary>
		Public Class PropertySystemJournal
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property Contacts() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Journal.Contacts
			...
			''' </summary>
			Public ReadOnly Property EntryType() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Journal.EntryType
		...
		''' System.LayoutPattern Properties
		''' </summary>
		Public Class PropertySystemLayoutPattern
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property ContentViewModeForBrowse() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.LayoutPattern.ContentViewModeForBrowse
			...
			''' </summary>
			Public ReadOnly Property ContentViewModeForSearch() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.LayoutPattern.ContentViewModeForSearch
		...
		''' System.Link Properties
		''' </summary>
		Public Class PropertySystemLink
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property Arguments() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Link.Arguments
			...
			Public ReadOnly Property Comment() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Link.Comment
			...
			''' </summary>
			Public ReadOnly Property DateVisited() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.Link.DateVisited
			...
			Public ReadOnly Property Description() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Link.Description
			...
			''' </summary>
			Public ReadOnly Property Status() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Link.Status
			...
			''' </summary>
			Public ReadOnly Property TargetExtension() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Link.TargetExtension
			...
			''' </summary>
			Public ReadOnly Property TargetParsingPath() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Link.TargetParsingPath
			...
			''' </summary>
			Public ReadOnly Property TargetSFGAOFlags() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Link.TargetSFGAOFlags
			...
			''' </summary>
			Public ReadOnly Property TargetSFGAOFlagsStrings() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Link.TargetSFGAOFlagsStrings
			...
			''' </summary>
			Public ReadOnly Property TargetUrl() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Link.TargetUrl
		...
		''' System.Media Properties
		''' </summary>
		Public Class PropertySystemMedia
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property AuthorUrl() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.AuthorUrl
			...
			''' </summary>
			Public ReadOnly Property AverageLevel() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.AverageLevel
			...
			''' </summary>
			Public ReadOnly Property ClassPrimaryID() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.ClassPrimaryID
			...
			''' </summary>
			Public ReadOnly Property ClassSecondaryID() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.ClassSecondaryID
			...
			''' </summary>
			Public ReadOnly Property CollectionGroupID() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.CollectionGroupID
			...
			''' </summary>
			Public ReadOnly Property CollectionID() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.CollectionID
			...
			''' </summary>
			Public ReadOnly Property ContentDistributor() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.ContentDistributor
			...
			''' </summary>
			Public ReadOnly Property ContentID() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.ContentID
			...
			''' </summary>
			Public ReadOnly Property CreatorApplication() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.CreatorApplication
			...
			''' </summary>
			Public ReadOnly Property CreatorApplicationVersion() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.CreatorApplicationVersion
			...
			''' </summary>
			Public ReadOnly Property DateEncoded() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.DateEncoded
			...
			''' </summary>
			Public ReadOnly Property DateReleased() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.DateReleased
			...
			''' </summary>
			Public ReadOnly Property Duration() As ShellProperty(Of System.Nullable(Of UInt64))
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.Duration
			...
			''' </summary>
			Public ReadOnly Property DVDID() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.DVDID
			...
			''' </summary>
			Public ReadOnly Property EncodedBy() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.EncodedBy
			...
			''' </summary>
			Public ReadOnly Property EncodingSettings() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.EncodingSettings
			...
			''' </summary>
			Public ReadOnly Property FrameCount() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.FrameCount
			...
			''' </summary>
			Public ReadOnly Property MCDI() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.MCDI
			...
			''' </summary>
			Public ReadOnly Property MetadataContentProvider() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.MetadataContentProvider
			...
			''' </summary>
			Public ReadOnly Property Producer() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.Producer
			...
			''' </summary>
			Public ReadOnly Property PromotionUrl() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.PromotionUrl
			...
			''' </summary>
			Public ReadOnly Property ProtectionType() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.ProtectionType
			...
			''' </summary>
			Public ReadOnly Property ProviderRating() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.ProviderRating
			...
			''' </summary>
			Public ReadOnly Property ProviderStyle() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.ProviderStyle
			...
			''' </summary>
			Public ReadOnly Property Publisher() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.Publisher
			...
			''' </summary>
			Public ReadOnly Property SubscriptionContentId() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.SubscriptionContentId
			...
			''' </summary>
			Public ReadOnly Property Subtitle() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.Subtitle
			...
			''' </summary>
			Public ReadOnly Property UniqueFileIdentifier() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.UniqueFileIdentifier
			...
			''' </summary>
			Public ReadOnly Property UserNoAutoInfo() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.UserNoAutoInfo
			...
			''' </summary>
			Public ReadOnly Property UserWebUrl() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.UserWebUrl
			...
			''' </summary>
			Public ReadOnly Property Writer() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.Writer
			...
			''' </summary>
			Public ReadOnly Property Year() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Media.Year
		...
		''' System.Message Properties
		''' </summary>
		Public Class PropertySystemMessage
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property AttachmentContents() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.AttachmentContents
			...
			''' </summary>
			Public ReadOnly Property AttachmentNames() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.AttachmentNames
			...
			''' </summary>
			Public ReadOnly Property BccAddress() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.BccAddress
			...
			''' </summary>
			Public ReadOnly Property BccName() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.BccName
			...
			''' </summary>
			Public ReadOnly Property CcAddress() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.CcAddress
			...
			''' </summary>
			Public ReadOnly Property CcName() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.CcName
			...
			''' </summary>
			Public ReadOnly Property ConversationID() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.ConversationID
			...
			''' </summary>
			Public ReadOnly Property ConversationIndex() As ShellProperty(Of [Byte]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.ConversationIndex
			...
			''' </summary>
			Public ReadOnly Property DateReceived() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.DateReceived
			...
			''' </summary>
			Public ReadOnly Property DateSent() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.DateSent
			...
			''' </summary>
			Public ReadOnly Property Flags() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.Flags
			...
			''' </summary>
			Public ReadOnly Property FromAddress() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.FromAddress
			...
			''' </summary>
			Public ReadOnly Property FromName() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.FromName
			...
			''' </summary>
			Public ReadOnly Property HasAttachments() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.HasAttachments
			...
			''' </summary>
			Public ReadOnly Property IsFwdOrReply() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.IsFwdOrReply
			...
			''' </summary>
			Public ReadOnly Property MessageClass() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.MessageClass
			...
			''' </summary>
			Public ReadOnly Property ProofInProgress() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.ProofInProgress
			...
			''' </summary>
			Public ReadOnly Property SenderAddress() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.SenderAddress
			...
			''' </summary>
			Public ReadOnly Property SenderName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.SenderName
			...
			''' </summary>
			Public ReadOnly Property Store() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.Store
			...
			''' </summary>
			Public ReadOnly Property ToAddress() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.ToAddress
			...
			''' </summary>
			Public ReadOnly Property ToDoFlags() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.ToDoFlags
			...
			''' </summary>
			Public ReadOnly Property ToDoTitle() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.ToDoTitle
			...
			''' </summary>
			Public ReadOnly Property ToName() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Message.ToName
		...
		''' System.Music Properties
		''' </summary>
		Public Class PropertySystemMusic
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property AlbumArtist() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.AlbumArtist
			...
			''' </summary>
			Public ReadOnly Property AlbumID() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.AlbumID
			...
			''' </summary>
			Public ReadOnly Property AlbumTitle() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.AlbumTitle
			...
			''' </summary>
			Public ReadOnly Property Artist() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.Artist
			...
			''' </summary>
			Public ReadOnly Property BeatsPerMinute() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.BeatsPerMinute
			...
			''' </summary>
			Public ReadOnly Property Composer() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.Composer
			...
			''' </summary>
			Public ReadOnly Property Conductor() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.Conductor
			...
			''' </summary>
			Public ReadOnly Property ContentGroupDescription() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.ContentGroupDescription
			...
			''' </summary>
			Public ReadOnly Property DisplayArtist() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.DisplayArtist
			...
			''' </summary>
			Public ReadOnly Property Genre() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.Genre
			...
			''' </summary>
			Public ReadOnly Property InitialKey() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.InitialKey
			...
			''' </summary>
			Public ReadOnly Property IsCompilation() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.IsCompilation
			...
			''' </summary>
			Public ReadOnly Property Lyrics() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.Lyrics
			...
			''' </summary>
			Public ReadOnly Property Mood() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.Mood
			...
			''' </summary>
			Public ReadOnly Property PartOfSet() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.PartOfSet
			...
			''' </summary>
			Public ReadOnly Property Period() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.Period
			...
			''' </summary>
			Public ReadOnly Property SynchronizedLyrics() As ShellProperty(Of [Byte]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.SynchronizedLyrics
			...
			''' </summary>
			Public ReadOnly Property TrackNumber() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Music.TrackNumber
		...
		''' System.Note Properties
		''' </summary>
		Public Class PropertySystemNote
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property Color() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Note.Color
			...
			''' </summary>
			Public ReadOnly Property ColorText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Note.ColorText
		...
		''' System.Photo Properties
		''' </summary>
		Public Class PropertySystemPhoto
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property Aperture() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.Aperture
			...
			''' </summary>
			Public ReadOnly Property ApertureDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ApertureDenominator
			...
			''' </summary>
			Public ReadOnly Property ApertureNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ApertureNumerator
			...
			''' </summary>
			Public ReadOnly Property Brightness() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.Brightness
			...
			''' </summary>
			Public ReadOnly Property BrightnessDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.BrightnessDenominator
			...
			''' </summary>
			Public ReadOnly Property BrightnessNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.BrightnessNumerator
			...
			''' </summary>
			Public ReadOnly Property CameraManufacturer() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.CameraManufacturer
			...
			''' </summary>
			Public ReadOnly Property CameraModel() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.CameraModel
			...
			''' </summary>
			Public ReadOnly Property CameraSerialNumber() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.CameraSerialNumber
			...
			''' </summary>
			Public ReadOnly Property Contrast() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.Contrast
			...
			''' </summary>
			Public ReadOnly Property ContrastText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ContrastText
			...
			''' </summary>
			Public ReadOnly Property DateTaken() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.DateTaken
			...
			''' </summary>
			Public ReadOnly Property DigitalZoom() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.DigitalZoom
			...
			''' </summary>
			Public ReadOnly Property DigitalZoomDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.DigitalZoomDenominator
			...
			''' </summary>
			Public ReadOnly Property DigitalZoomNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.DigitalZoomNumerator
			...
			''' </summary>
			Public ReadOnly Property [Event]() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.[Event]
			...
			''' </summary>
			Public ReadOnly Property EXIFVersion() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.EXIFVersion
			...
			''' </summary>
			Public ReadOnly Property ExposureBias() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ExposureBias
			...
			''' </summary>
			Public ReadOnly Property ExposureBiasDenominator() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ExposureBiasDenominator
			...
			''' </summary>
			Public ReadOnly Property ExposureBiasNumerator() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ExposureBiasNumerator
			...
			''' </summary>
			Public ReadOnly Property ExposureIndex() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ExposureIndex
			...
			''' </summary>
			Public ReadOnly Property ExposureIndexDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ExposureIndexDenominator
			...
			''' </summary>
			Public ReadOnly Property ExposureIndexNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ExposureIndexNumerator
			...
			''' </summary>
			Public ReadOnly Property ExposureProgram() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ExposureProgram
			...
			''' </summary>
			Public ReadOnly Property ExposureProgramText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ExposureProgramText
			...
			''' </summary>
			Public ReadOnly Property ExposureTime() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ExposureTime
			...
			''' </summary>
			Public ReadOnly Property ExposureTimeDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ExposureTimeDenominator
			...
			''' </summary>
			Public ReadOnly Property ExposureTimeNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ExposureTimeNumerator
			...
			''' </summary>
			Public ReadOnly Property Flash() As ShellProperty(Of System.Nullable(Of [Byte]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.Flash
			...
			''' </summary>
			Public ReadOnly Property FlashEnergy() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FlashEnergy
			...
			''' </summary>
			Public ReadOnly Property FlashEnergyDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FlashEnergyDenominator
			...
			''' </summary>
			Public ReadOnly Property FlashEnergyNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FlashEnergyNumerator
			...
			''' </summary>
			Public ReadOnly Property FlashManufacturer() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FlashManufacturer
			...
			''' </summary>
			Public ReadOnly Property FlashModel() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FlashModel
			...
			''' </summary>
			Public ReadOnly Property FlashText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FlashText
			...
			''' </summary>
			Public ReadOnly Property FNumber() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FNumber
			...
			''' </summary>
			Public ReadOnly Property FNumberDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FNumberDenominator
			...
			''' </summary>
			Public ReadOnly Property FNumberNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FNumberNumerator
			...
			''' </summary>
			Public ReadOnly Property FocalLength() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FocalLength
			...
			''' </summary>
			Public ReadOnly Property FocalLengthDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FocalLengthDenominator
			...
			''' </summary>
			Public ReadOnly Property FocalLengthInFilm() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FocalLengthInFilm
			...
			''' </summary>
			Public ReadOnly Property FocalLengthNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FocalLengthNumerator
			...
			''' </summary>
			Public ReadOnly Property FocalPlaneXResolution() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FocalPlaneXResolution
			...
			''' </summary>
			Public ReadOnly Property FocalPlaneXResolutionDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FocalPlaneXResolutionDenominator
			...
			''' </summary>
			Public ReadOnly Property FocalPlaneXResolutionNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FocalPlaneXResolutionNumerator
			...
			''' </summary>
			Public ReadOnly Property FocalPlaneYResolution() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FocalPlaneYResolution
			...
			''' </summary>
			Public ReadOnly Property FocalPlaneYResolutionDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FocalPlaneYResolutionDenominator
			...
			''' </summary>
			Public ReadOnly Property FocalPlaneYResolutionNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.FocalPlaneYResolutionNumerator
			...
			''' </summary>
			Public ReadOnly Property GainControl() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.GainControl
			...
			''' </summary>
			Public ReadOnly Property GainControlDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.GainControlDenominator
			...
			''' </summary>
			Public ReadOnly Property GainControlNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.GainControlNumerator
			...
			''' </summary>
			Public ReadOnly Property GainControlText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.GainControlText
			...
			''' </summary>
			Public ReadOnly Property ISOSpeed() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ISOSpeed
			...
			''' </summary>
			Public ReadOnly Property LensManufacturer() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.LensManufacturer
			...
			''' </summary>
			Public ReadOnly Property LensModel() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.LensModel
			...
			''' </summary>
			Public ReadOnly Property LightSource() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.LightSource
			...
			''' </summary>
			Public ReadOnly Property MakerNote() As ShellProperty(Of [Byte]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.MakerNote
			...
			''' </summary>
			Public ReadOnly Property MakerNoteOffset() As ShellProperty(Of System.Nullable(Of UInt64))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.MakerNoteOffset
			...
			''' </summary>
			Public ReadOnly Property MaxAperture() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.MaxAperture
			...
			''' </summary>
			Public ReadOnly Property MaxApertureDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.MaxApertureDenominator
			...
			''' </summary>
			Public ReadOnly Property MaxApertureNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.MaxApertureNumerator
			...
			''' </summary>
			Public ReadOnly Property MeteringMode() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.MeteringMode
			...
			''' </summary>
			Public ReadOnly Property MeteringModeText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.MeteringModeText
			...
			''' </summary>
			Public ReadOnly Property Orientation() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.Orientation
			...
			''' </summary>
			Public ReadOnly Property OrientationText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.OrientationText
			...
			''' </summary>
			Public ReadOnly Property PeopleNames() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.PeopleNames
			...
			''' </summary>
			Public ReadOnly Property PhotometricInterpretation() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.PhotometricInterpretation
			...
			''' </summary>
			Public ReadOnly Property PhotometricInterpretationText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.PhotometricInterpretationText
			...
			''' </summary>
			Public ReadOnly Property ProgramMode() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ProgramMode
			...
			''' </summary>
			Public ReadOnly Property ProgramModeText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ProgramModeText
			...
			''' </summary>
			Public ReadOnly Property RelatedSoundFile() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.RelatedSoundFile
			...
			''' </summary>
			Public ReadOnly Property Saturation() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.Saturation
			...
			''' </summary>
			Public ReadOnly Property SaturationText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.SaturationText
			...
			''' </summary>
			Public ReadOnly Property Sharpness() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.Sharpness
			...
			''' </summary>
			Public ReadOnly Property SharpnessText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.SharpnessText
			...
			''' </summary>
			Public ReadOnly Property ShutterSpeed() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ShutterSpeed
			...
			''' </summary>
			Public ReadOnly Property ShutterSpeedDenominator() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ShutterSpeedDenominator
			...
			''' </summary>
			Public ReadOnly Property ShutterSpeedNumerator() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.ShutterSpeedNumerator
			...
			''' </summary>
			Public ReadOnly Property SubjectDistance() As ShellProperty(Of System.Nullable(Of [Double]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.SubjectDistance
			...
			''' </summary>
			Public ReadOnly Property SubjectDistanceDenominator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.SubjectDistanceDenominator
			...
			''' </summary>
			Public ReadOnly Property SubjectDistanceNumerator() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.SubjectDistanceNumerator
			...
			''' </summary>
			Public ReadOnly Property TagViewAggregate() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.TagViewAggregate
			...
			''' </summary>
			Public ReadOnly Property TranscodedForSync() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.TranscodedForSync
			...
			''' </summary>
			Public ReadOnly Property WhiteBalance() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.WhiteBalance
			...
			''' </summary>
			Public ReadOnly Property WhiteBalanceText() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Photo.WhiteBalanceText
		...
		''' System.PropGroup Properties
		''' </summary>
		Public Class PropertySystemPropGroup
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property Advanced() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.Advanced
			...
			''' </summary>
			Public ReadOnly Property Audio() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.Audio
			...
			''' </summary>
			Public ReadOnly Property Calendar() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.Calendar
			...
			''' </summary>
			Public ReadOnly Property Camera() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.Camera
			...
			''' </summary>
			Public ReadOnly Property Contact() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.Contact
			...
			''' </summary>
			Public ReadOnly Property Content() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.Content
			...
			''' </summary>
			Public ReadOnly Property Description() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.Description
			...
			''' </summary>
			Public ReadOnly Property FileSystem() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.FileSystem
			...
			''' </summary>
			Public ReadOnly Property General() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.General
			...
			''' </summary>
			Public ReadOnly Property GPS() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.GPS
			...
			''' </summary>
			Public ReadOnly Property Image() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.Image
			...
			''' </summary>
			Public ReadOnly Property Media() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.Media
			...
			''' </summary>
			Public ReadOnly Property MediaAdvanced() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.MediaAdvanced
			...
			''' </summary>
			Public ReadOnly Property Message() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.Message
			...
			''' </summary>
			Public ReadOnly Property Music() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.Music
			...
			''' </summary>
			Public ReadOnly Property Origin() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.Origin
			...
			''' </summary>
			Public ReadOnly Property PhotoAdvanced() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.PhotoAdvanced
			...
			''' </summary>
			Public ReadOnly Property RecordedTV() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.RecordedTV
			...
			''' </summary>
			Public ReadOnly Property Video() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropGroup.Video
		...
		''' System.PropList Properties
		''' </summary>
		Public Class PropertySystemPropList
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property ConflictPrompt() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropList.ConflictPrompt
			...
			Public ReadOnly Property ContentViewModeForBrowse() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropList.ContentViewModeForBrowse
			...
			Public ReadOnly Property ContentViewModeForSearch() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropList.ContentViewModeForSearch
			...
			''' </summary>
			Public ReadOnly Property ExtendedTileInfo() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropList.ExtendedTileInfo
			...
			''' </summary>
			Public ReadOnly Property FileOperationPrompt() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropList.FileOperationPrompt
			...
			''' </summary>
			Public ReadOnly Property FullDetails() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropList.FullDetails
			...
			''' </summary>
			Public ReadOnly Property InfoTip() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropList.InfoTip
			...
			''' </summary>
			Public ReadOnly Property NonPersonal() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropList.NonPersonal
			...
			''' </summary>
			Public ReadOnly Property PreviewDetails() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropList.PreviewDetails
			...
			''' </summary>
			Public ReadOnly Property PreviewTitle() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropList.PreviewTitle
			...
			''' </summary>
			Public ReadOnly Property QuickTip() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropList.QuickTip
			...
			''' </summary>
			Public ReadOnly Property TileInfo() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropList.TileInfo
			...
			''' </summary>
			Public ReadOnly Property XPDetailsPanel() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.PropList.XPDetailsPanel
		...
		''' System.RecordedTV Properties
		''' </summary>
		Public Class PropertySystemRecordedTV
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property ChannelNumber() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.RecordedTV.ChannelNumber
			...
			''' </summary>
			Public ReadOnly Property Credits() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.RecordedTV.Credits
			...
			''' </summary>
			Public ReadOnly Property DateContentExpires() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.RecordedTV.DateContentExpires
			...
			''' </summary>
			Public ReadOnly Property EpisodeName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.RecordedTV.EpisodeName
			...
			''' </summary>
			Public ReadOnly Property IsATSCContent() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.RecordedTV.IsATSCContent
			...
			''' </summary>
			Public ReadOnly Property IsClosedCaptioningAvailable() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.RecordedTV.IsClosedCaptioningAvailable
			...
			''' </summary>
			Public ReadOnly Property IsDTVContent() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.RecordedTV.IsDTVContent
			...
			''' </summary>
			Public ReadOnly Property IsHDContent() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.RecordedTV.IsHDContent
			...
			''' </summary>
			Public ReadOnly Property IsRepeatBroadcast() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.RecordedTV.IsRepeatBroadcast
			...
			''' </summary>
			Public ReadOnly Property IsSAP() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.RecordedTV.IsSAP
			...
			''' </summary>
			Public ReadOnly Property NetworkAffiliation() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.RecordedTV.NetworkAffiliation
			...
			''' </summary>
			Public ReadOnly Property OriginalBroadcastDate() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.RecordedTV.OriginalBroadcastDate
			...
			''' </summary>
			Public ReadOnly Property ProgramDescription() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.RecordedTV.ProgramDescription
			...
			''' </summary>
			Public ReadOnly Property RecordingTime() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.RecordedTV.RecordingTime
			...
			''' </summary>
			Public ReadOnly Property StationCallSign() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.RecordedTV.StationCallSign
			...
			''' </summary>
			Public ReadOnly Property StationName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.RecordedTV.StationName
		...
		''' System.Search Properties
		''' </summary>
		Public Class PropertySystemSearch
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property AutoSummary() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Search.AutoSummary
			...
			''' </summary>
			Public ReadOnly Property ContainerHash() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Search.ContainerHash
			...
			''' </summary>
			Public ReadOnly Property Contents() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Search.Contents
			...
			''' </summary>
			Public ReadOnly Property EntryID() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Search.EntryID
			...
			''' </summary>
			Public ReadOnly Property ExtendedProperties() As ShellProperty(Of [Byte]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Search.ExtendedProperties
			...
			''' </summary>
			Public ReadOnly Property GatherTime() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.Search.GatherTime
			...
			''' </summary>
			Public ReadOnly Property HitCount() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Search.HitCount
			...
			''' </summary>
			Public ReadOnly Property IsClosedDirectory() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Search.IsClosedDirectory
			...
			''' </summary>
			Public ReadOnly Property IsFullyContained() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Search.IsFullyContained
			...
			''' </summary>
			Public ReadOnly Property QueryFocusedSummary() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Search.QueryFocusedSummary
			...
			''' </summary>
			Public ReadOnly Property QueryFocusedSummaryWithFallback() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Search.QueryFocusedSummaryWithFallback
			...
			''' </summary>
			Public ReadOnly Property Rank() As ShellProperty(Of System.Nullable(Of Int32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Search.Rank
			...
			Public ReadOnly Property Store() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Search.Store
			...
			''' </summary>
			Public ReadOnly Property UrlToIndex() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Search.UrlToIndex
			...
			''' </summary>
			Public ReadOnly Property UrlToIndexWithModificationTime() As ShellProperty(Of [Object])
				Get
					Dim key As PropertyKey = SystemProperties.System.Search.UrlToIndexWithModificationTime
		...
		''' System.Shell Properties
		''' </summary>
		Public Class PropertySystemShell
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property OmitFromView() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Shell.OmitFromView
			...
			''' </summary>
			Public ReadOnly Property SFGAOFlagsStrings() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Shell.SFGAOFlagsStrings
		...
		''' System.Software Properties
		''' </summary>
		Public Class PropertySystemSoftware
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property DateLastUsed() As ShellProperty(Of System.Nullable(Of DateTime))
				Get
					Dim key As PropertyKey = SystemProperties.System.Software.DateLastUsed
			...
			''' </summary>
			Public ReadOnly Property ProductName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Software.ProductName
		...
		Public Class PropertySystemSync
			...
			''' </summary>
			Public ReadOnly Property Comments() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Sync.Comments
			...
			''' </summary>
			Public ReadOnly Property ConflictDescription() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Sync.ConflictDescription
			...
			''' </summary>
			Public ReadOnly Property ConflictFirstLocation() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Sync.ConflictFirstLocation
			...
			''' </summary>
			Public ReadOnly Property ConflictSecondLocation() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Sync.ConflictSecondLocation
			...
			''' </summary>
			Public ReadOnly Property HandlerCollectionID() As ShellProperty(Of System.Nullable(Of IntPtr))
				Get
					Dim key As PropertyKey = SystemProperties.System.Sync.HandlerCollectionID
			...
			''' </summary>
			Public ReadOnly Property HandlerID() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Sync.HandlerID
			...
			''' </summary>
			Public ReadOnly Property HandlerName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Sync.HandlerName
			...
			''' </summary>
			Public ReadOnly Property HandlerType() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Sync.HandlerType
			...
			''' </summary>
			Public ReadOnly Property HandlerTypeLabel() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Sync.HandlerTypeLabel
			...
			''' </summary>
			Public ReadOnly Property ItemID() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Sync.ItemID
			...
			Public ReadOnly Property ItemName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Sync.ItemName
			...
			''' </summary>
			Public ReadOnly Property ProgressPercentage() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Sync.ProgressPercentage
			...
			''' </summary>
			Public ReadOnly Property State() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Sync.State
			...
			Public ReadOnly Property Status() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Sync.Status
		...
		''' System.Task Properties
		''' </summary>
		Public Class PropertySystemTask
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property BillingInformation() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Task.BillingInformation
			...
			''' </summary>
			Public ReadOnly Property CompletionStatus() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Task.CompletionStatus
			...
			''' </summary>
			Public ReadOnly Property Owner() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Task.Owner
		...
		''' System.Video Properties
		''' </summary>
		Public Class PropertySystemVideo
			Inherits PropertyStoreItems
			...
			Public ReadOnly Property Compression() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Video.Compression
			...
			''' </summary>
			Public ReadOnly Property Director() As ShellProperty(Of [String]())
				Get
					Dim key As PropertyKey = SystemProperties.System.Video.Director
			...
			Public ReadOnly Property EncodingBitrate() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Video.EncodingBitrate
			...
			''' </summary>
			Public ReadOnly Property FourCC() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Video.FourCC
			...
			''' </summary>
			Public ReadOnly Property FrameHeight() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Video.FrameHeight
			...
			''' </summary>
			Public ReadOnly Property FrameRate() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Video.FrameRate
			...
			''' </summary>
			Public ReadOnly Property FrameWidth() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Video.FrameWidth
			...
			''' </summary>
			Public ReadOnly Property HorizontalAspectRatio() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Video.HorizontalAspectRatio
			...
			Public ReadOnly Property SampleSize() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Video.SampleSize
			...
			Public ReadOnly Property StreamName() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Video.StreamName
			...
			Public ReadOnly Property StreamNumber() As ShellProperty(Of System.Nullable(Of UInt16))
				Get
					Dim key As PropertyKey = SystemProperties.System.Video.StreamNumber
			...
			''' </summary>
			Public ReadOnly Property TotalBitrate() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Video.TotalBitrate
			...
			Public ReadOnly Property TranscodedForSync() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Video.TranscodedForSync
			...
			''' </summary>
			Public ReadOnly Property VerticalAspectRatio() As ShellProperty(Of System.Nullable(Of UInt32))
				Get
					Dim key As PropertyKey = SystemProperties.System.Video.VerticalAspectRatio
		...
		''' System.Volume Properties
		''' </summary>
		Public Class PropertySystemVolume
			Inherits PropertyStoreItems
			...
			''' </summary>
			Public ReadOnly Property FileSystem() As ShellProperty(Of [String])
				Get
					Dim key As PropertyKey = SystemProperties.System.Volume.FileSystem
			...
			''' </summary>
			Public ReadOnly Property IsMappedDrive() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Volume.IsMappedDrive
			...
			''' </summary>
			Public ReadOnly Property IsRoot() As ShellProperty(Of System.Nullable(Of [Boolean]))
				Get
					Dim key As PropertyKey = SystemProperties.System.Volume.IsRoot
