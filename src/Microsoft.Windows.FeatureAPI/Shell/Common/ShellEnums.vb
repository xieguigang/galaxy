...
Namespace Shell
	...
	''' <summary>
	''' Provides a set of flags to be used with <see cref="Shell.SearchCondition"/> 
	''' to indicate the operation in <see cref="Shell.SearchConditionFactory"/> methods.
	''' </summary>
	...
	''' <summary>
	''' Set of flags to be used with <see cref="Shell.SearchConditionFactory"/>.
	''' </summary>
	Public Enum SearchConditionType
		...
		''' constant value using a <see cref="Shell.SearchConditionOperation"/>.
		''' </summary>
		Leaf = 3
	End Enum
