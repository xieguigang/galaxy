...
Namespace Shell
	...
	Friend NotInheritable Class FolderTypes
		...
		Shared Sub New()
			...
			types.Add(NotSpecified, GlobalLocalizedMessages.FolderTypeNotSpecified)
			types.Add(Invalid, GlobalLocalizedMessages.FolderTypeInvalid)
			types.Add(Communications, GlobalLocalizedMessages.FolderTypeCommunications)
			types.Add(CompressedFolder, GlobalLocalizedMessages.FolderTypeCompressedFolder)
			types.Add(Contacts, GlobalLocalizedMessages.FolderTypeContacts)
			types.Add(ControlPanelCategory, GlobalLocalizedMessages.FolderTypeCategory)
			types.Add(ControlPanelClassic, GlobalLocalizedMessages.FolderTypeClassic)
			types.Add(Documents, GlobalLocalizedMessages.FolderTypeDocuments)
			types.Add(Games, GlobalLocalizedMessages.FolderTypeGames)
			types.Add(GenericSearchResults, GlobalLocalizedMessages.FolderTypeSearchResults)
			types.Add(GenericLibrary, GlobalLocalizedMessages.FolderTypeGenericLibrary)
			types.Add(Library, GlobalLocalizedMessages.FolderTypeLibrary)
			types.Add(Music, GlobalLocalizedMessages.FolderTypeMusic)
			types.Add(MusicIcons, GlobalLocalizedMessages.FolderTypeMusicIcons)
			types.Add(NetworkExplorer, GlobalLocalizedMessages.FolderTypeNetworkExplorer)
			types.Add(OtherUsers, GlobalLocalizedMessages.FolderTypeOtherUsers)
			types.Add(OpenSearch, GlobalLocalizedMessages.FolderTypeOpenSearch)
			types.Add(Pictures, GlobalLocalizedMessages.FolderTypePictures)
			types.Add(Printers, GlobalLocalizedMessages.FolderTypePrinters)
			types.Add(RecycleBin, GlobalLocalizedMessages.FolderTypeRecycleBin)
			types.Add(RecordedTV, GlobalLocalizedMessages.FolderTypeRecordedTV)
			types.Add(SoftwareExplorer, GlobalLocalizedMessages.FolderTypeSoftwareExplorer)
			types.Add(SavedGames, GlobalLocalizedMessages.FolderTypeSavedGames)
			types.Add(SearchConnector, GlobalLocalizedMessages.FolderTypeSearchConnector)
			types.Add(Searches, GlobalLocalizedMessages.FolderTypeSearches)
			types.Add(UsersLibraries, GlobalLocalizedMessages.FolderTypeUserLibraries)
			types.Add(UserFiles, GlobalLocalizedMessages.FolderTypeUserFiles)
			types.Add(Videos, GlobalLocalizedMessages.FolderTypeVideos)
		End Sub
