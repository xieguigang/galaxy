...
Namespace Dialogs
	...
	Public Interface IDialogControlHost
		...
		Function IsCollectionChangeAllowed() As Boolean

		''' <summary>
		''' Applies changes to the collection.
		''' </summary>
		Sub ApplyCollectionChanged()
		...
		Function IsControlPropertyChangeAllowed(propertyName As String, control As DialogControl) As Boolean
		...
		Sub ApplyControlPropertyChange(propertyName As String, control As DialogControl)
	End Interface
End Namespace
