...
Namespace Controls
	Public Class MaterialCheckBox
		...
		Public Sub New()
			...
			AddHandler CheckedChanged, Sub(sender, args) 
			animationManager.StartNewAnimation(If(Checked, AnimationDirection.[In], AnimationDirection.Out))
		...
		Protected Overrides Sub OnPaint(pevent As PaintEventArgs)
			...
			Using checkmarkPath = DrawHelper.CreateRoundRect(boxOffset, boxOffset, 17, 17, 1F)
